...
- Name: ajustes.spec.ts >> Redirects post-login >> login preserva redirect query param
- Location: tests\e2e\ajustes.spec.ts:90:3
...
Received string:  "http://localhost:5173/login?redirect=%2Fbuscar"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    9 × unexpected value "http://localhost:5173/login?redirect=%2Fbuscar"
